...
const AuthSection: React.FC<AuthSectionProps> = ({ children }) => {
  return (
    <section id="auth" className="min-h-screen w-screen flex justify-center items-center" data-testid="auth">
      ...
      <div className="md:w-1/2 px-8 md:px-16 space-y-5">
        <div data-testid="logo" className="logo bg-[#CFD4ED] w-[100px] h-[34px]"></div>
